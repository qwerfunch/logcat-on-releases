...
export const STRINGS = {
  ko: {
    ...
    'features.design.desc': 'Canvas 렌더링으로 대용량 로그도 부드럽게 스크롤됩니다.',
    ...
    'features.signal.desc': '미니맵·이슈·타임라인 어디서든 포착해, 그 지점으로 바로 이동.',
    'features.perf.title': '성능을 실시간으로, 한눈에',
    'features.perf.desc': 'CPU·메모리·버벅임·배터리·온도를 로그와 나란히 모니터링합니다.',
  ...
  en: {
    ...
    'features.design.desc': 'Canvas rendering keeps even large logs scrolling smoothly.',
    ...
    'features.signal.desc': 'Spot them on the minimap, issues, or timeline — and jump right to the spot.',
  ...
  ja: {
    ...
    'features.design.desc': 'Canvas レンダリングで、大量のログも滑らかにスクロール。',
    ...
    'features.signal.desc': 'ミニマップ・課題・タイムラインのどこからでも捕捉し、その箇所へすぐ移動。',
  ...
  zh: {
    ...
    'features.design.desc': '基于 Canvas 渲染,海量日志也能顺畅滚动。',
    ...
    'features.signal.desc': '在迷你地图、问题列表或时间轴随处捕捉,并直达发生位置。',
